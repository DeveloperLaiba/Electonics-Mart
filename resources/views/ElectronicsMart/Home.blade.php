...
@section('content')
    @foreach ($hbackgroundimage as $item)
        ...
        background-size: 100% 100%;">
                            <div class="div"> <span class="spa">{{ $item->paragraph1 }}
                                    {{ $item->paragraph2 }}</span><span class="spa1">{{ $item->paragraph3 }}</span><span
                                    class="spa"> {{ $item->paragraph4 }}</span>
                                <div class="col-lg-4 spa1">{{ $item->heading }}</div>
                                <div class="col-lg-2 spa1">{{ $item->heading2 }}</div>
                                <button class="btt">{{ $item->button }}</button>
                            </div>
                        </div>
                    @endforeach
                </div>
                        ...
                        <div class="col-lg-3 bg-body-tertiary ">
                            ...
                            <marquee behavior="" direction="up" style="height: 40vh;">
                                <div class="card mb-3" style="max-width:240px; height: 25vh; border: none;">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="Image/k1.png" class="img-fluid rounded-start pt-4 ps-3"
                                                alt="...">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <a href="" class="ccolor">Samsung Galaxy F62 (Laser Grey, 128 GB)
                                                    (6 GB RAM)
                                                </a><br>
                                ...
                                <div class="card mb-3" style="max-width:240px; height: 25vh; border: none;">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="Image/k2.png" class="img-fluid rounded-start pt-4 ps-3"
                                                alt="...">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <a href="" class="ccolor">Samsung 192 L Direct Cool Single Door
                                                    3(2021)
                                                    Refrigerator</a><br>
                                ...
                                <div class="card mb-3" style="max-width:240px; height: 25vh; border: none;">
                                    <div class="row g-0">
                                        <div class="col-md-4">
                                            <img src="Image/k3.png" class="img-fluid rounded-start pt-4 ps-3"
                                                alt="...">
                                        </div>
                                        <div class="col-md-8">
                                            <div class="card-body">
                                                <a href="" class="ccolor">boAt Rockerz 450 Bluetooth Headset
                                                    (Luscious Black, On the
                                                    Ear)</a><br>
                                        ...
                                        <div class="card text-center">
                                            ...
                                            <div class="card-body mb-3">
                                                <a href="{{ route('Cart', $item->id) }}" style="text-decoration: none;">
                                                    <h5 class="price-weight mt-4">{{ $item->name }}</h5>
                                                </a>
                                                <p class="price-mar">{{ $item->price }} &nbsp;<del
                                                        class="ope">{{ $item->price2 }}</del></p>
                                                <a class="add-to-cart-btn" href="{{ route('Cart', $item->id) }}"
                                                    style="text-decoration: none;">{{ $item->button }}</a>
                                            </div>
                                        </div>
                                        <!-- card end -->
                                    </div>
                                        ...
                                        @foreach ($excitingdeal as $item)
                                            ...
                                            <div class="col-md-7">
                                                <img src="{{ asset('image/' . $item->image) }}"
                                                    class="img-fluid rounded-start excimg" alt="...">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="card mb-3 pb1" style="max-width: 34rem; margin-left: 5%;">
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-4 pt-3">
                                        <img src="{{ asset('image/' . $item->image) }}" class="img-fluid rounded-start"
                                            alt="...">
                                    </div>
                                </div>
                            </div>
